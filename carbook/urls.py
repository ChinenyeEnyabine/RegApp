...
from .views import  CarBookingViewSet,  CarViewSet, ListCarBookingViewSet, OrderListViewSet, OrderViewSet
...
router.register(r'listcarbooking', ListCarBookingViewSet, basename='listcarbooking')
